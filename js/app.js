    ...
    var data = { "experiences" : [
        {
            ...
            "employer" : "Telenor Norge AS",
            "period" : "Nov 2018 - Present",
            "location" : "Trondheim, Norway",
            "summary" : "I've been tasked with automating the installation of API platform Apigee (a Google product) using Ansible. Task includes installing, upgrading and maintenance of the platform. Enviroment separated in three; local machine Dev installation, AWS test installation and VMWare Prod installation."
        },
        {
            "title" : "Developer",
            "employer" : "Acando AS",
            ...
            "location" : "Trondheim, Norway",
            "summary" : "I worked on a project for the Norwegian Geological Survey, building an API for their registation product for Geophysical surveys. We built the backend on microservices architecture, running on Spring, using an Oracle / ESRI database backend. Also worked on maintenance of their Android app for Well-registration."
        },
        {
